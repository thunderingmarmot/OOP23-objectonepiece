...
\subsection*{Prototipo}
Il mondo di gioco contiene le sezioni ed è responsabile della creazione di nuove sezione e di caricare quelle salvate.
%
...
%
Mentre le isole, i barili e le mine possono solo essere collisi dalle navi.
%
Una nave è composta da 4 componenti che sono: la chiglia, la prua, la vela e l'arma.
...
%
Il range di sparo è di tre caselle sia per il player che per i nemici e fa un danno AoE (Area of Effect) di 3x3 caselle.
%
Il giocatore può curarsi e salvare su una isola premendo il tasto sinistro mentre è affianco ad essa
%
